...
import com.example.job6.R.id

class MortyAdapter (val dataMorty: List<ResultsItem?>?) : RecyclerView.Adapter<MortyAdapter.MyViewHolder>() {
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val imgMorty = view.findViewById<ImageView>(id.img_card)
        val nameMorty = view.findViewById<TextView>(id.item_name_morty)
        val statusMorty = view.findViewById<TextView>(id.descMorty)
